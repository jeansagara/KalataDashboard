...
AjouterProjet(){
 // console.log("datttttttttttttttt"+this.ajoutModel.this.file)
  ...
  this.projetdelois.ajoutprojet(this.image,this.ajoutModel.titre,
    this.ajoutModel.description, this.ajoutModel.datedebut1, this.ajoutModel.datefin1,  this.ajoutModel.heuredebut,this.ajoutModel.heurefin, this.ajoutModel.nbredeselus,this.spec).subscribe((data: any) =>{
      this.ajouts=data
    })
